...
void setup() {
  ...
  //Serial Monotoring
  Serial.begin(9600);
  Serial.print("Robot Arm Initializing \n");
  Serial.print("Servo01");
  Serial.print(Dynamixel.readPosition(servo01));
  Serial.print("Servo02");
  Serial.print(Dynamixel.readPosition(servo02));
  Serial.print(Dynamixel.readPosition(servo03));
  Serial.print(Dynamixel.readPosition(servo04));
  Serial.print(Dynamixel.readPosition(servo05));
  float test = Dynamixel.readPosition(servo05);
  Serial.print(test);
